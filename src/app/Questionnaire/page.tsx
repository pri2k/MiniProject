...
// import QuestionCard from "@/components/QuestionCard"; // make sure the path is correct
...
//   const questions = dummyQuestions[selectedTopic as keyof typeof dummyQuestions];
